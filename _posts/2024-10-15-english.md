...
**<font color=red>音标整体认读的时候元音与辅音的组合</font>**
> + 两个元音之间有一个辅音的时候，辅音归后面的元音。
+ 两个元音之间有两个辅音的时候，前面的辅音归前面的元音，后面的辅音归后面的元音。
+ **<font color=red>如果两个辅音不可拆分属于组合时，归后面的元音，e.g. teacher / ˈtiːtʃər / tʃ 属于组合</font>**
