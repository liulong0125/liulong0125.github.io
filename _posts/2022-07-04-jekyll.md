...
[中文官网](jekyll.com.cn)、[英文官网](https://jekyllrb.com/)、[主题模板官网](http://jekyllthemes.org/)
...
![blogs-16](/static/img/blogs-16.jpg)
...
![blogs-05](/static/img/blogs-08.jpg)



![blogs-05](/static/img/blogs-07.jpg)
...
![blogs-09](/static/img/blogs-09.jpg)

>   +   需要通过 ``bundle exec jekyll serve``  命令启动。



![blogs-05](/static/img/blogs-10.jpg)

>   +   遇到依赖包没有安装的，需要根据提示在 Gemfile 中添加对应的安装包。



![blogs-05](/static/img/blogs-11.jpg)
...
![blogs-01](/static/img/blogs-01.jpg)

<center><font size=2 color=gray>克隆代码到自己 github 下</font></center>

![blogs-02](/static/img/blogs-02.jpg)

>   +   重命名项目为固定的格式。

![blogs-03](/static/img/blogs-03.jpg)

>   +   进入 github pages 页面配置。

![blogs-04](/static/img/blogs-04.jpg)

>   +   配置 github page。



![blogs-05](/static/img/blogs-05.jpg)
...
+   全局变量。
    ...
    +   content 变量。- 引用的文件的内容，一层一层嵌套。
        ...
        ![blogs-13](/static/img/blogs-13.jpg)
...
![blogs-14](/static/img/blogs-14.jpg)
...
+   navigation 模块。
    ...
    ![blogs-15](/static/img/blogs-15.jpg)
    ...
    ![blogs-16](/static/img/blogs-17.jpg)
