...
// 安装 bundler，安装后通过执行 bundle install 安装 项目要求的版本的 Gemfile 和 Gemfile.lock 的依赖包
gem install bundler
...
bundle install
```
> 可以先安装 bundler 配置好 bundle 的源执行 bunlde install 安装 Gemfile 的依赖即可。
...
[Liquid 教程](https://liquid.devjs.cn/basics/introduction/)
